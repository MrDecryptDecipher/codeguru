...
export class AppState {
  ...
  public realtimeAssistant: RealtimeAssistant
  ...
  constructor() {
    ...
    // Initialize Realtime assistant
    this.realtimeAssistant = new RealtimeAssistant(this)
  ...
  public getRealtimeAssistant(): RealtimeAssistant {
    return this.realtimeAssistant
  }

  public getClipboardMonitor(): ClipboardMonitor {
  ...
  app.whenReady().then(() => {
    ...
    appState.clipboardMonitor.on('code-detected', (detection) => {
      ...
      if (mainWindow && !mainWindow.isDestroyed()) {
        mainWindow.webContents.send('code-detected', detection)
      }
    })
  })
