...
function readOpenRouterEnvConfig(): { apiKey: string; models: string[] } | null {
  ...
  const modelsRaw = process.env.OPENROUTER_MODELS || "kwaipilot/kat-coder-pro:free,qwen/qwen3-coder:free,moonshotai/kimi-k2:free,tngtech/deepseek-r1t2-chimera:free,alibaba/tongyi-deepresearch-30b-a3b:free,x-ai/grok-4.1-fast,google/gemma-3-27b-it:free,meituan/longcat-flash-chat:free,nvidia/nemotron-nano-9b-v2:free,openai/gpt-oss-20b:free,z-ai/glm-4.5-air:free,qwen/qwen3-14b:free,cognitivecomputations/dolphin-mistral-24b-venice-edition:free,openrouter/bert-nebulon-alpha,nvidia/nemotron-nano-12b-v2-vl:free"
